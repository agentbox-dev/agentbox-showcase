...
export async function GET(request: NextRequest) {
  try {
    ...
    // 构建目标API URL
    const targetUrl = apiUrlHelpers.teamMembers(teamId)

    console.log('🔄 Proxying user-team-by-team request to:', targetUrl)
    ...
    console.log('✅ Successfully proxied user-team-by-team request')
